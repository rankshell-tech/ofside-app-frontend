    ...
    <SafeAreaView className="flex-1 bg-white p-1">
                        ...
                        <View className="flex-row">
                            ...
                            <View
                                ...
                                <Picker
                                    ...
                                    style={{ width: "100%" }}
                                >
                                    <Picker.Item label="Select Your Team" value="" />
                                </Picker>
                            </View>
                        </View>
                    :
        ...
        {tabType === "Performance" && (
            ...
            >
                <View className="flex-row px-2">
                    <LinearGradient
                      ...
                      >
                        ...
                        {top3MVPList.map((item, index) => (
                            <LinearGradient
                              key={`${item.name}-${index}`} // ✅ unique key
                              colors={["#1e40af", "#000000"]}
                              start={{ x: 0, y: 0 }}
                              end={{ x: 1, y: 0 }}
                              className="flex-row justify-between items-center border overflow-hidden rounded-md bg-white p-2 my-1">
                                <Text className="font-bold text-sm text-white mr-2">{item.name}</Text>
                                <Text className="font-bold text-sm text-white mr-2">{item.matches}</Text>
                                <Text className="font-bold text-sm text-white">{item.pts}</Text>
                            </LinearGradient>
                        ))}
                ...
                >
                  {/* Title + Legend row */}
                  <View className="w-full flex-row justify-between items-start px-1">
                    {/* Title */}
                    <Text className="font-bold text-[13px] text-gray-900">
